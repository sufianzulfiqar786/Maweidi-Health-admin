...
const AddXrayModal = ({ open, onClose, xrays, title = 'Add', Id, setModalNav, modalNav }) => {
    const handleCancel = () => {
        onClose();
    };
    console.log("modalNav", modalNav)
                    ...
                    <div className="row ">
                        ...
                        <div className="col-lg-6 pr-3 pl-2">
                            <div class="form-group">
                                <label>Select X Ray Lab<span className="text-danger">*</span> </label>
