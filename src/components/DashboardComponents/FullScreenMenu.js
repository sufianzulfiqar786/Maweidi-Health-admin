...
const FullScreenMenu = ({
  ...
  return (
    <div className="hover-effect">
      ...
      {ValidUI() === "superAdmin" || ValidUI() === "HospitalAdmin" ? <Link className="maweidi-link ml-md-auto ml-0 " to="/dashboard">
        <div
      ...
      {/* Appointments */}
      {ValidUI() === "Doctor" || ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <Link className="maweidi-link ml-md-auto ml-0" to="/appointment">
        <div
          className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
          onClick={() => {
            setMenuDropDownFullScreen({
      ...
      {/* hospital  */}
     {ValidUI() === "superAdmin" ? <Link className="maweidi-link ml-md-auto ml-0" to="/hospitals">
        <div
          className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
          onClick={() => {
            setMenuDropDownFullScreen({
     ...
     { ValidUI() === "Doctor" || ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <div
        className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
      >
        <div
          className=" row "
        ...
        >
          ...
          >
            <img
              ...
              src={`${menuDropDownFullScreen.name === "doc" ? DownIconBlue : DownIcon
                }`}
              alt=""
            ...
            menuDropDownFullScreen.name === "doc" && (
              <>
                ...
                <span class="dot"></span>
                  ...
                  <Link className="maweidi-link " to="/doctors">
                    <span
                      className={`pl-lg-2 ${menuDropDownFullScreen.subMenuMobile.subname == "alldoc"
                          ? "seleted-menu"
                          : ""
                        } `}
                      onClick={() => {
     ...
     { ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <div
        className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
      >
        <div
          className=" row"
    ...
    { ValidUI() === "PharmacyAdmin" || ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ?  <div
        className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
      >
        <div
          className=" row"
     ...
     {ValidUI() === "LaboratoryAdmin" || ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <div
        className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center ${menuIconCenter} ${menuIconLeftPadding}`}
      >
        <div
          className=" row"
            ...
            menuDropDownFullScreen.name === "laboratory" && (
              <>
                ...
                <div className="col-12">
                  {menuDropDownFullScreen.subMenuMobile.subtoggle &&
                    menuDropDownFullScreen.subMenuMobile.subname ==
                    "bloodtest" && (
                      <>
                        <div className="pl-5 ml-3 ">
                          <p
                            className="mb-0 pt-2 third-sub-menu"
                            style={{ fontSize: "12px" }}
                          >
                            {/* <img className="" src={LeftDropIcon} alt="" /> */}
                            <Link
                              className="maweidi-link text-dark"
                              to="/bloodtest/orderlist"
                            >
                              <span className="pl-1">Ordered List</span>
                            </Link>
                          </p>
                        </div>
      ...
      {/* Blood donation */}
     {  ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <Link className="maweidi-link ml-md-auto ml-0 w-100" to="blood-donation">
        <div
      ...
      {ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <Link className="maweidi-link ml-md-auto ml-0 w-100 " to="/home-service-provider">
        <div
          className={`mt-lg-4 mt-0 pt-1 d-flex align-items-center  w-100 ${menuIconCenter} ${menuIconLeftPadding}`}
          onClick={() => {
            setMenuDropDownFullScreen({
        ...
        >
          ...
          >
            ...
            >
              ...
              <Link className="maweidi-link text-left" to="/home-service-provider">
                <span style={{ display: `${menuLeftText}` }}>
                  <p
     ...
     {  ValidUI() === "HospitalAdmin" || ValidUI() === "superAdmin" ? <Link className="maweidi-link ml-md-auto ml-0 w-100 " to="bannerpromo">
        ...
        >
          <div className=" row " style={{ display: `${menuLeftText}`, width: "100%" }}>
            <div
              className={`${menuLeftRightDropDown1} d-flex align-items-center w-100  ${menuIconCenter}`}
            >
              <div className="  dashboard-left-icon">
                <img className="py-1" src={`${menuDropDownFullScreen.name === "bannerpromo" ? bluePromo : promoIcon
                  }`} alt="" />
              </div>
