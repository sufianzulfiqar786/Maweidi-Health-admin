              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="form-group full-width">
                  <label class="required">Location</label>
                    <Location handleLocation={handleLocationIconClick} locationProp={formData.location}/>
                  {showMap && (
                    <GoogleMap locationProp = {formData.location} setLocationProp={handleLocationChange}/>
                  )}
                </div>
                ...
                <div class="two-group">
                  <div class="form-group">
                    ...
                    <CustomDropDown selectLabel='Select' option={specialistOptions} handleChangeSelect={handleSpecializationChange} value={formData.specialization} />
                  </div>
                  <div class="form-group">
                    <label>Doctor</label>
                    <CustomDropDown selectLabel='Select' option={doctors} handleChangeSelect={handleDoctorsChange} value={formData.doctor_name}/>
                  <label style={{fontSize:"12px", marginBottom:'-15px'}}>Please confirm the doctor's availability and <span className="font-weight-bold text-dark cursor-pointer"  onClick={() => setModal2Open(true)}> time table</span>  before 
booking an appointmen</label >
                  </div>
                </div>
                ...
                <div class="three-group">
                  ...
                  <div class="form-group">
                    ...
                    <div className="border d-flex align-items-center justify-content-center" style={{borderRadius:"5px", height:"36.6px"}}>
                    <PhoneInput
                    className=""
                    style={{border:"none"}}
                      country="US"
