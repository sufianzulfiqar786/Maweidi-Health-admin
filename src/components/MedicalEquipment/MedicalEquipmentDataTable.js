...
const MedicalEquipmentDataTable = ({
  searchQuery,
  ...
  const handleDelete = () => {
    deleteData(
      ...
      () => {
        ...
        CustomToast({
          type: "success",
          message: "Medical Equipment Delete Successfuly!",
        });
      }
    );
  };
                ...
                visibleRows?.map(
                  (
                    ...
                    >
                      ...
                      <TableCell>
                        <Link to={`/medical/equipment/update/${id}`}>
...
export default MedicalEquipmentDataTable;
