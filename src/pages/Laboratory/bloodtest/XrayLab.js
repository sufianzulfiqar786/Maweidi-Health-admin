...
import AddXrayModal from "../../../components/laboratory/bloodtest/AddXrayModal";
import XrayWrapper from "../../../components/common/XrayWrapper";
    ...
    <>
      ...
      <div className="row mb-lg-5 mb-4 pb-5 px-3  pt-4 bloodtest-tab">
        <div className="col-12">
          <p className="mb-0 bloodtest-heading">X-ray</p>
        </div>
