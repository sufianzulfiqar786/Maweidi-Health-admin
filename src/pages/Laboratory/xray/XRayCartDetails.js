...
import xrayIcon from "../../../assets/images/laboratory/xray/xray.svg";

const XRayCartDetails = () => {
  const rows = [
    {
      number: "1",
  ...
  return (
    <>
      <div className="row pl-3 pr-2 pt-4 mb-5 pb-5 testcartdetails-tab ">
        <div className="col-12">
          <p className="mb-0 testcartdetails-heading">X-Ray Cart Details</p>
        </div>
          ...
          <div className="row ">
            <div className="col-md-12">
              <p className="testcartdetails-breadcrumb">
                ...
                <img src={Chevron} />
                <span className="current-tab"> X-RAYS CART DETAILS</span>
              </p>
            </div>
          </div>
        </div>
...
export default XRayCartDetails;
