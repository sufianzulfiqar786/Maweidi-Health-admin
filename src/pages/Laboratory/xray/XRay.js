...
const BloodTest = () => {
  ...
  return (
    <>
      ...
      <div className="row px-3 mb-lg-5 mb-4  pb-5 pt-4 bloodtest-tab">
          ...
          <div className="row ">
            ...
            <BreadCrum
              ...
              {/* <p className="bloodtest-breadcrumb">
                ...
                <img src={Chevron} />
                <span className="current-tab"> X-RAYS</span>
              </p> */}
            </div>
        ...
        <LaboratoryWrapper
          title="X-Rays Details"
          requestSectionTitle="X-Rays Request"
          rows={rows}
          icon={xrayIcon}
        />
      </div>
