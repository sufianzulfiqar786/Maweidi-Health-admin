...
import NewMedicalEquipmentForm from "../../components/MedicalEquipment/NewMedicalEquipmentForm";


const AddMedicalEquipment = ({ Id }) => {
    ...
    <>
      <div className="row px-3  pt-4 addpatient-tab">
        <div className="col-12">
          <p className="mb-0 addpatient-heading">Add Medical Equipment</p>
        </div>
          ...
          <div className="row ">
            <div className="col-lg-12 ">
              <BreadCrum
                ...
                secondText={Id ? "Update Medical Equipment" : "Add Medical Equipment"}
              />
            </div>
          </div>
        </div>
