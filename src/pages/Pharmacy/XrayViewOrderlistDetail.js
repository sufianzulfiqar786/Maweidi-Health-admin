...
const XrayViewOrderlistDetail = (Id) => {
    ...
    const getProductDetail = useFetch(
        `get_blood_test_order_details/${Id.Id}`
    );
    ...
    const verifyBtn = (Idverify) => {
        ...
        verifyPostData?.postData(
            `change_blood_test_order_status/${Id.Id}`,
            updatedPostData1,
            (res) => {
                ...
                navigate("/xray/orderlist");

            }
        );
    }

    console.log("getProductDetail.data?.dataasd", getProductDetail.data?.data?.blood_tests)
                ...
                <div className="col-12">
                    <div className="row d-flex align-items-end">
                        <div className="col-lg-6 col-12 mt-4 pt-1">
                            <BreadCrum
                                firstLink="/xray/orderlist"
                                firstText="X-ray"
                                secondText="Test Request"
                            />
                        </div>
                        ...
                        >
                            <Table aria-label="simple table">
                                ...
                                >
                                    ...
                                    {getProductDetail.data?.data?.blood_tests?.map(({ id, name, price, total, address }, index) => (
                                        <TableRow
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">
                                                ...
                                                <div className='pharmacy-product-view-prodeuct-cell'>
                                                    <span className='pharmacy-product-view-prodeuct-cell-text1 pl-3 pr-4'>{index + 1}</span>
                                                    {/* <img src={`${process.env.REACT_APP_IMAGE_URL + '/' + images[0]}`} alt="" />  */}
                                                    <span className='pl-2 pharmacy-product-view-prodeuct-cell-text2'>{name}</span>
                                                </div>
                    ...
                    <div className="col-md-4 mt-4 pt-3 mb-5 ">
                        ...
                        <div className='pharmacy-product-approve'>
                            ...
                            <div className="row mx-0">
                                ...
                                {getProductDetail?.data?.data?.status === null ? <div className="col-12 py-4  d-flex justify-content-end">
...
export default XrayViewOrderlistDetail